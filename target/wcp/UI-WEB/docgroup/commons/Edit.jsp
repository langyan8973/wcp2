...
<c:if test="${group!=null&&group.id!=null}">
	<c:set var="action" value="index/DocGroupEditCommit.htm"></c:set>
</c:if>
<!-- 新增 -->
<c:if test="${group==null||group.id==null}">
	<c:set var="action" value="index/DocGroupAddCommit.htm"></c:set>
</c:if>
<form role="form" action="${action}" id="knowSubmitFormId" method="post">
	<input type="hidden" name="group.id" id="group_id" value="${group.id}" />
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="group.groupname"
			...
			<div class="form-group">
				...
				<select class="form-control" id="group_joincheck"
					name="group.joincheck" val="${group.joincheck}">
					<option value="0">
						自由加入
					</option>
					<option value="1">
			...
			<div class="form-group">
				<label for="exampleInputEmail1">
					小组头像(200px*200px)<span class="alertMsgClass">*</span>
				</label>
				<div>
					<input type="hidden" name="group.groupimg" id="group_groupimg"
						value="${group.groupimg}" />
		...
		<div class="col-md-6" style="text-align: center;">
			<c:if test="${group.groupimg==null}">
				<img id="groupPhotoId" src="UI-WEB/docgroup/resource/index.jpeg"
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="group.grouptag"
					value="${group.grouptag}" id="group_grouptag"
					placeholder="输入小组标签,如：科技、技术...标签间用逗号分隔" />
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				<textarea name="group.groupnote" id="group_groupnote"
					class="form-control" rows="3">${group.groupnote}</textarea>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
			<button type="button" id="knowSubmitButtonId" class="btn btn-primary">
				提交
			</button>&nbsp;&nbsp;<span class="alertMsgClass" id="errormessageShowboxId"></span>
		</div>
	</div>
</form>
<script>
