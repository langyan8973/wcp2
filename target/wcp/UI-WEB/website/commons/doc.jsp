...
<div class="row">
	<div class="col-md-8">
		...
		<div style="text-align: center;">
			<hr />
			<a href="index/FPwebSiteIndex.do?id=${doc.id}"
				class="btn btn-primary btn-lg glyphicon glyphicon-home">&nbsp;访问站点首页</a>
			<hr />
		</div>
		<p>
			${doc.texts.text1}
	...
	<div class="col-md-4">
		...
		<jsp:include page="../../know/commons/includeDocFiles.jsp"></jsp:include><jsp:include
			page="../../know/commons/includeDocVersions.jsp"></jsp:include>
	</div>
</div>
	...
	$(function() {
		$('#editTopButtonId')
				.bind(
						'click',
						function() {
							window.location = basePath + 'index/webSiteEditPage.htm?id=${doc.id}';
						});
		$('#docMessageId')
				.bind(
						'click',
