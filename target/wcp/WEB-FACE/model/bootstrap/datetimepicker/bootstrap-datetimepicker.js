...
!function ($) {
	...
	Datetimepicker.prototype = {
		...
		setDayColor: function (date) {
			$('.day',this.picker.find('.datetimepicker-days tbody')).each(function(i,obj){
				if(!$(this).hasClass("old")&&!$(this).hasClass("new")){
					if($(obj).text()==String(parseInt(date))){
						$(this).css("color","#F98667");
						$(this).css("font-weight","bold");
					}
				}
			});
		},
		removeDayColor: function () {
			$('.day',this.picker.find('.datetimepicker-days tbody')).each(function(i,obj){
				if(!$(this).hasClass("old")&&!$(this).hasClass("new")){
					if($(this).css("color")=='rgb(249, 134, 103)'){
