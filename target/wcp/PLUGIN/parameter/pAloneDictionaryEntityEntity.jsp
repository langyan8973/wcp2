...
<script type="text/javascript">
	var submitAddActionDictinary = 'admin/ALONEDictionary_ADD_SUBMIT.do';
	var submitEditActionDictinary = 'admin/ALONEDictionary_EDIT_SUBMIT.do';
	var currentPageTypeDictinary = '${pageset.pageType}';
