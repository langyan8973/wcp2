		...
		<form id="dom_formparameter">
			...
			<table class="editTable">
				<tr>
					...
					<td colspan="3">
						<input type="text" class="easyui-validatebox" style="width: 360px;"
				...
				<tr>
					...
					<td>
						<select name="entity.vtype" id="entity_vtype"
							val="${entity.vtype}">
							<option value="1">
								字符串
							</option>
				...
				<tr>
					...
					<td>
						<input type="text" class="easyui-validatebox"
							...
							id="entity_pvalue" name="entity.pvalue" value="${entity.pvalue}">
					</td>
					<td class="title">
						用户个性化:
					</td>
					<td>
						<select name="entity.userable" id="entity_userable"
							val="${entity.userable}">
							<option value="0">
								否
							</option>
				...
				<tr>
					...
					<td colspan="3">
						...
						<input type="text" class="easyui-validatebox"
							...
							id="entity_rules" name="entity.rules" value="${entity.rules}">
					</td>
				</tr>
				<tr>
					<td class="title">
...
<script type="text/javascript">
	var submitAddActionparameter = 'admin/AloneParameteraddCommit.do';
	var submitEditActionparameter = 'admin/AloneParametereditCommit.do';
	var currentPageTypeparameter = '${pageset.pageType}';
