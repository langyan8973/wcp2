...
<script type="text/javascript">
	var url_delActionLog = "admin/AloneApplogdeleteCommit.do";
	var url_formActionLog = "admin/AloneApplogshow.do";
	var url_searchActionLog =  "admin/AloneApplogqueryAll.do";
	...
	function viewDataLog() {
		...
		if (selectedArray.length == 1) {
			var url = url_formActionLog + '?pageset.pageType='
