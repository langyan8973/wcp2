...
<html>
	...
	<body>
		...
		<div class="demo-info">
			...
			<div>
				用户个性化参数配置，修改后请保存。<PF:ParameterValue key="jdbc.url "/>
			</div>
		</div>
		<div style="padding: 4px;">
			...
			<div style="margin: 8px;">
				<table id="propertyTable_ID" class="easyui-propertygrid"
					style="width: 600px"
					data-options="url: 'admin/AloneParameterUserqueryForEasyUi.do',showGroup: true,scrollbarSize: 0,columns: mycolumns">
				</table>
			</div>
		</div>
	</body>
	...
	$('#a_tree_save').bind(
			...
			function() {
				...
				$.post(
						'admin/AloneParam_editSubmitByUserPValue.do',
						{
							ids : paraSubmitVar
						},
						function(flag) {
