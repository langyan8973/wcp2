...
<script type="text/javascript">
    var url_delActionDiclisttype = "admin/ALONEDictionaryType_DEL_SUBMIT.do";//删除URL
    var url_formActionDiclisttype = "admin/ALONEDictionaryType_VIEW_SUBMIT.do";//增加、修改、查看URL
    var url_searchActionDiclisttype = "admin/ALONEDictionaryType_SYSBASE_QUERYALL.do?ids=${ids}";//查询URL
    ...
    function viewDataDiclisttype() {
      ...
      if (selectedArray.length == 1) {
        var url = url_formActionDiclisttype + '?pageset.pageType='+PAGETYPE.VIEW+'&ids='
            + selectedArray[0].ID;
        $.farm.openWindow( {
          id : 'winDiclisttype',
          width : 600,
    ...
    function addDataDiclisttype() {
      var url = url_formActionDiclisttype + '?dicId=${ids}&pageset.pageType='+PAGETYPE.ADD;
      $.farm.openWindow( {
        id : 'winDiclisttype',
        width : 600,
        height : 300,
    ...
    function editDataDiclisttype() {
      var selectedArray = $(gridDiclisttype).datagrid('getSelections');
      if (selectedArray.length == 1) {
        var url = url_formActionDiclisttype + '?pageset.pageType='+PAGETYPE.EDIT+ '&ids=' + selectedArray[0].ID;
        $.farm.openWindow( {
          id : 'winDiclisttype',
          width : 600,
          height : 300,
