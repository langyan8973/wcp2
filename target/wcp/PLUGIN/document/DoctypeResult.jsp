...
<html>
	...
	<body class="easyui-layout">
		<div data-options="region:'west',split:true,border:false"
			...
			<div class="TREE_COMMON_BOX_SPLIT_DIV">
				...
				<a id="DoctypeTreeOpenAll" href="javascript:void(0)"
					class="easyui-linkbutton" data-options="plain:true"
					...
					<table class="editTable">
						<tr>
							...
							<td>
								...
								<input id="PARENTID_RULE" name="a.PARENTID:=" type="hidden">
							</td>
							<td class="title"></td>
							<td></td>
						</tr>
	...
	var url_delActionDoctype = "admin/FarmDoctypedeleteCommit.do";//删除URL
	var url_formActionDoctype = "admin/FarmDoctypeshow.do";//增加、修改、查看URL
	var url_searchActionDoctype = "admin/FarmDoctypequeryAll.do";//查询URL
		...
		$('#DoctypeTree').tree( {
			...
			onSelect : function(node) {
				...
				searchDoctype.dosearch( {
					'query.ruleText' : searchDoctype.arrayStr()
				});
			}
		});
	...
	function viewDataDoctype() {
		...
		if (selectedArray.length == 1) {
			var url = url_formActionDoctype + '?pageset.pageType='
	...
	function addDataDoctype() {
		var url = url_formActionDoctype + '?parent.id='
