...
<html>
	...
	var url_delActionDocfile = "admin/FarmDocfiledeleteCommit.do";//删除URL
	var url_formActionDocfile = "admin/FarmDocfileshow.do";//增加、修改、查看URL
	var url_searchActionDocfile = "admin/FarmDocfilequeryAll.do";//查询URL
