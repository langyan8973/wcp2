				...
				<tr>
					...
					<td colspan="3">
						<input type="text" style="width: 360px;"
							...
							id="entity_filename" name="entity.filename"
				...
				<tr>
					...
					<td>
						<input type="text" style="width: 360px;"
							...
							id="entity_exname" name="entity.exname" value="${entity.exname}">
					</td>
				</tr>
				<tr>
					<td class="title">
					...
					<td>
						...
						<select id="entity_type" name="entity.type" val="${entity.type}">
							<option value="1">
								图片
							</option>
							<option value="0">
					...
					<td>
						<select id="entity_pstate" name="entity.pstate"
							val="${entity.pstate}">
							<option value="1">
								使用
							</option>
				...
				<tr>
					...
					<td colspan="3">
						<input type="text" style="width: 360px;"
							...
							id="entity_dir" name="entity.dir" value="${entity.dir}">
					</td>
				</tr>
...
<script type="text/javascript">
	var submitAddActionDocfile = 'admin/FarmDocDocfileaddCommit.do';
	var submitEditActionDocfile = 'admin/FarmDocDocfileeditCommit.do';
	var currentPageTypeDocfile = '${pageset.pageType}';
