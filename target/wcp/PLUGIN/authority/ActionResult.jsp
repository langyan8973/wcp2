...
<html>
	...
	var url_delActionAction = "admin/FarmAuthorityActiondeleteCommit.do";//删除URL
	var url_formActionAction = "admin/FarmAuthorityActionShow.do";//增加、修改、查看URL
	var url_searchActionAction = "admin/FarmAuthorityActionQuery.do";//查询URL
	...
	function viewDataAction() {
		...
		if (selectedArray.length == 1) {
			var url = url_formActionAction + '?pageset.pageType='
	...
	function addDataAction() {
		var url = url_formActionAction + '?pageset.pageType=' + PAGETYPE.ADD;
		$.farm.openWindow( {
			id : 'winAction',
			width : 600,
			height : 300,
