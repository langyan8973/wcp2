		...
		<form id="dom_formAction">
			...
			<table class="editTable">
				...
				<tr>
					...
					<td colspan="3">
						<input type="text" style="width: 360px;"
							...
							id="entity_authkey" name="entity.authkey"
				...
				<tr>
					...
					<td>
						<select name="entity.loginis" id="entity_loginis"
							val="${entity.loginis}">
							<option value="1">
								是
							</option>
					...
					<td>
						<select name="entity.checkis" id="entity_checkis"
							val="${entity.checkis}">
							<option value="1">
								是
							</option>
...
<script type="text/javascript">
	var submitAddActionAction = 'admin/FarmAuthorityActionaddCommit.do';
	var submitEditActionAction = 'admin/FarmAuthorityActioneditCommit.do';
	var currentPageTypeAction = '${pageset.pageType}';
