				...
				<tr>
					...
					<td colspan="3">
						...
						<input type="hidden" id="entity_descript"
							value="${entity.descript}" name="entity.descript">
					</td>
				</tr>
				<tr>
					<td class="title">
...
<script type="text/javascript">
	var submitAddActionfarmqztrigger = 'admin/FarmQzTriggeraddCommit.do';
	var submitEditActionfarmqztrigger = 'admin/FarmQzTriggereditCommit.do';
	var currentPageTypefarmqztrigger = '${pageset.pageType}';
