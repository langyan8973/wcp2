...
<html>
	...
	var url_delActionfarmqztask = "admin/FarmQzTaskdeleteCommit.do";
	var url_formActionfarmqztask = "admin/FarmQzTaskshow.do";
	var url_searchActionfarmqztask = "admin/FarmQzTaskqueryAll.do";
	...
	function viewDatafarmqztask() {
		...
		if (selectedArray.length > 0) {
			var url = url_formActionfarmqztask + '?pageset.pageType='
