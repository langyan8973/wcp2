 ...
 * Hibernate {@link org.hibernate.SessionFactory}. This is the usual way to set
 * up a shared Hibernate SessionFactory in a Spring application context; the
 * SessionFactory can then be passed to Hibernate-based data access objects via
 * dependency injection.
 * 
 * <p>
 * <b>NOTE:</b> This variant of LocalSessionFactoryBean requires Hibernate 4.0
 * or higher. It is similar in role to the same-named class in the
 * <code>orm.hibernate3</code> package. However, in practice, it is closer to
 * <code>AnnotationSessionFactoryBean</code> since its core purpose is to
 * bootstrap a <code>SessionFactory</code> from annotation scanning.
 * 
 * <p>
 * <b>NOTE:</b> To set up Hibernate 4 for Spring-driven JTA transactions, make
 * sure to either specify the {@link #setJtaTransactionManager
 * "jtaTransactionManager"} bean property or to set the
 * "hibernate.transaction.factory_class" property to
...
public class LocalSessionFactoryBean extends HibernateExceptionTranslator
		implements FactoryBean<SessionFactory>, ResourceLoaderAware,
	 ...
	 */
	public void setCacheableMappingLocations(
	...
	public void afterPropertiesSet() throws IOException {
		LocalSessionFactoryBuilder sfb = new LocalSessionFactoryBuilder(
				this.dataSource, this.resourcePatternResolver);
			...
			ConfDirHandle.findDirForConf(Thread.currentThread()
					...
					UserConfPack.split(","), new ConfHandleInter() {
						...
						public void execute(Object para, File file) {
							LocalSessionFactoryBuilder sfb = (LocalSessionFactoryBuilder) para;
							String strFileName = file.getAbsolutePath()
									.toLowerCase();
							if (strFileName.endsWith(".hbm.xml")) {
								sfb.addFile(file);
							}
						}
					}, (Object) sfb);
			...
			for (Resource resource : this.mappingDirectoryLocations) {
				...
				if (!file.isDirectory()) {
					throw new IllegalArgumentException(
							"Mapping directory location [" + resource
	...
	public Class<?> getObjectType() {
		return (this.sessionFactory != null ? this.sessionFactory.getClass()
