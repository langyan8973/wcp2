...
public class WormKnowHandle implements WormDocHandleInter {
	...
	private static final Logger log = Logger.getLogger(WormKnowHandle.class);
	...
	public void handle(Map<String, String> doc, FarmWormProject pro,
		...
		knowIMP.creatKnow(doc.get("TITLE"), appPara.get("TYPEID"), httpdoc
				.getDocument().html(), null, POP_TYPE.DOCGROUP,
				POP_TYPE.DOCGROUP, appPara.get("GROUPID"), manager
						.getAuthorityService().getUserByLoginName(
								appPara.get("LOGINNAME")));
	}
