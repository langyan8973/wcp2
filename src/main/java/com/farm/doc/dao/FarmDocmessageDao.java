 ...
 * 
 */
public class FarmDocmessageDao implements FarmDocmessageDaoInter {
	private SessionFactory sessionFatory;
	private HibernateSQLTools<FarmDocmessage> sqlTools;
	...
	public HibernateSQLTools<FarmDocmessage> getSqlTools() {
		return sqlTools;
	}

	public void setSqlTools(HibernateSQLTools<FarmDocmessage> sqlTools) {
