...
<html>
	...
	var url_delActionfarmqztrigger = "admin/FarmQzTriggerdeleteCommit.do";
	var url_formActionfarmqztrigger = "admin/FarmQzTriggershow.do";
	var url_searchActionfarmqztrigger = "admin/FarmQzTriggerqueryAll.do";
	...
	function viewDatafarmqztrigger() {
		...
		if (selectedArray.length > 0) {
			var url = url_formActionfarmqztrigger + '?pageset.pageType='
