		...
		<form id="dom_formfarmqzscheduler">
			...
			<table class="editTable">
				<tr>
					...
					<td colspan="3">
						<select name="entity.autois" id="entity_autois"
							val="${entity.autois}">
							<option value="1">
								自动
							</option>
				...
				<tr>
					...
					<td colspan="3">
						...
						<input type="hidden" id="entity_taskid" name="entity.taskid"
							value="${entity.taskid}" />
				...
				<tr>
					...
					<td colspan="3">
						<input type="text" style="width: 360px;" readonly="readonly"
							...
							value="${triggerStr}"
							data-options="required:true,validType:',maxLength[16]'">
						<input type="hidden" id="entity_triggerid" name="entity.triggerid"
...
<script type="text/javascript">
	var submitAddActionfarmqzscheduler = 'admin/FarmQzScheduleraddCommit.do';
	var submitEditActionfarmqzscheduler = 'admin/FarmQzSchedulereditCommit.do';
	var currentPageTypefarmqzscheduler = '${pageset.pageType}';
