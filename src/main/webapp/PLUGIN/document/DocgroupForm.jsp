				...
				<tr>
					...
					<td colspan="3">
						<input type="text" style="width: 360px;"
							...
							id="entity_groupname" name="entity.groupname"
							value="${entity.groupname}">
					</td>
					<td id="imgTdId" rowspan="5"
						style="text-align: center; width: 200px;">
						<c:if test="${entity.imgurl!=null}">
							<img style='max-width: 100%;max-height: 300px;' src='${entity.imgurl}' />
						</c:if>
				...
				<tr>
					...
					<td colspan="3">
						<textarea rows="2" style="width: 360px;"
							...
							id="entity_groupnote" name="entity.groupnote">${entity.groupnote}</textarea>
					</td>
				</tr>
				<tr>
					<td class="title">
					...
					<td colspan="3">
						<input type="text" style="width: 360px;"
							...
							id="entity_grouptag" name="entity.grouptag"
	...
	$(function() {
		...
		uploadbutton.fileBox.change(function(e) {
			uploadbutton.submit();
						...
						<input type="hidden" id="entity_fileid" name="entity.groupimg"
...
<script type="text/javascript">
	var submitAddActionDocgroup = 'admin/FarmDocgroupaddCommit.do';
	var submitEditActionDocgroup = 'admin/FarmDocgroupeditCommit.do';
	var currentPageTypeDocgroup = '${pageset.pageType}';
