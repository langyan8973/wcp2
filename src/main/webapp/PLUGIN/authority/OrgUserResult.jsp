...
<table id="dataPostUserGrid">
	<thead>
		<tr>
			...
			<th field="POSTNAME" data-options="sortable:true" width="20">
				岗位
			</th>
...
<script type="text/javascript">
	var url_delActionPostUser = "admin/FarmAuthorityRemovePostUserCommit.do";//删除URL
	var url_searchActionPostUser = "admin/FarmAuthorityOrgUserQuery.do?ids="
			+ $('#domTabsId').val();//查询URL
