	...
	<div data-options="region:'center'">
		<form id="dom_formActiontree">
			...
			<c:if test="${pageset.pageType==1}">
				<input type="hidden" id="entity_domain" name="entity.domain"
					value="${domain}">
			</c:if>
        ...
        无
					...
					<td>
						<input type="hidden" id="entity_img_id" name="entity.icon"
							value="${entity.icon}">
						<a id="chooseImg" class="easyui-linkbutton"
							data-options="iconCls:'${entity.icon}'">选择</a>
					</td>
				</tr>
				<tr>
					<td class="title">
				...
				<tr id="URL_TR_DOM">
					...
					<td colspan="3">
						<input type="text" class="easyui-validatebox"
							...
							id="entity_action_title" name="treeAction.authkey"
							value="${treeAction.authkey}">
						<input type="hidden" value="${entity.actionid}"
							id="entity_actionid" name="entity.actionid">
				...
				<tr id="PARAMS_TR_DOM">
					...
					<td colspan="3">
						<input type="text" style="width: 360px;"
							...
							name="entity.params" value="${entity.params}">
					</td>
				</tr>
...
<script type="text/javascript">
	var submitAddActionActiontree = 'admin/FarmAuthorityActiontreeAddCommit.do';
	var submitEditActionActiontree = 'admin/FarmAuthorityActiontreeEditCommit.do';
	var currentPageTypeActiontree = '${pageset.pageType}';
	...
	$(function() {
		...
		$('#chooseImg').bind('click', function() {
			$.farm.openWindow( {
				...
				height : 300,
				modal : true,
				url : "admin/ALONEMenu_ACTION_cssIcon.do",
				title : '选择图标'
			});
		});
		$('#form_AloneAction_a_ChoosePop').bind('click', function() {
			$.farm.openWindow( {
				...
				height : 300,
				modal : true,
				url : "admin/FarmAuthorityActionChoose.do",
				title : '选择权限'
			});
		});
