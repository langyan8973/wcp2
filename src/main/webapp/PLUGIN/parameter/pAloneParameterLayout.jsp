...
<html>
			...
			<table id="dataparameterGrid">
				<thead>
					<tr>
						...
						<th field="DOMAIN" data-options="sortable:true" width="20">
							域
						</th>
						<th field="NAME" data-options="sortable:true" width="80">
							名称
						</th>
						<th field="PKEY" data-options="sortable:true" width="80">
							键
						</th>
	...
	var url_delActionparameter = "admin/AloneParameterdeleteCommit.do";//删除URL
	var url_formActionparameter = "admin/AloneParametershow.do";//增加、修改、查看URL
	var url_searchActionparameter = "admin/AloneParameterqueryAll.do";//查询URL
	...
	function viewDataparameter() {
		...
		if (selectedArray.length == 1) {
			var url = url_formActionparameter + '?pageset.pageType='
	...
	function addDataparameter() {
		var url = url_formActionparameter + '?pageset.pageType=' + PAGETYPE.ADD;
		$.farm.openWindow( {
			id : 'winparameter',
			width : 600,
			height : 300,
